package hwa.helloworld.myplayerservice;
...
public class MainActivity extends AppCompatActivity {
    ...
    // true : 재생, false : 정지
    TextView tv_start_music, tv_end_music;
    ProgressBar pb_bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_start_music = (TextView)findViewById(R.id.tv_start_music);
        tv_end_music = (TextView)findViewById(R.id.tv_end_music);
